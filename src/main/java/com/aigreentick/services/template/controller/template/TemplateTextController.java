...
public class TemplateTextController {
        ...
        public ResponseEntity<?> updateVariableDefaults(
                ...
                List<TemplateTextResponseDto> updatedVariables = templateTextService.updateVariableDefaults(
                                templateId,
                                userId,
                                request.getDefaults());
        ...
        public ResponseEntity<?> updateSingleVariableDefault(
                ...
                TemplateTextResponseDto updatedVariable = templateTextService.updateSingleVariableDefault(
                                templateId,
                                variableId,
                                userId,
